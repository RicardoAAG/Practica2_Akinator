...
if len(personajes["personajes"]) == 1:
    ...
    nueva_respuesta: str = input("No se ha encontrado un personaje que coincida con las respuestas proporcionadas. ¿En quién estabas pensando? ")
    ...
    if nueva_respuesta.lower() != 'saltar':
        ...
        print(f'Gracias, aprendí un nuevo personaje: {nueva_respuesta}')
